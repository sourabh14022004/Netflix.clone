...
const Navbar = () => {
  ...
  return (
  <div className= "absolute w-full p-4 flex items-center justify-between z-50 bg-gradient-to-b from-black">
    <Link to='/'>
    ...
    {user?.email ? (
        <div>
          <Link to="/profile">
            ...
            className="capitalize bg-red-600 px-6 py-2 rounded cursor-pointer">logout</button>
        </div>
      ) : (
        <div>
          <Link to="/login">
